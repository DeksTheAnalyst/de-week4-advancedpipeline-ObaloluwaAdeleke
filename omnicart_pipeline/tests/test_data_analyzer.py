...
def sample_enriched_df():
    ...
    data = [
        {"username": "alice", "price": 100, "revenue": 1000, "id_product": 1},
        {"username": "alice", "price": 200, "revenue": 500, "id_product": 2},
        {"username": "bob", "price": 300, "revenue": 900, "id_product": 3},
    ]
...
def test_analyze_handles_empty_dataframe():
    ...
    empty_df = pd.DataFrame(columns=["username", "price", "revenue", "id_product"])
